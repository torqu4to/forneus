...
export const ui = {
  pt: {
    ...
    'profile.add_catpal': 'Adicionar amigato',
    'profile.remove_catpal': 'Remover',
    'profile.catpal_level': 'Nível atual',
    'profile.count': '{count} de {max} amigatos',
    'profile.empty_team': 'Adicione os amigatos que você já tem e o nível de cada um.',
  ...
  en: {
    ...
    'profile.add_catpal': 'Add catpal',
    'profile.remove_catpal': 'Remove',
    'profile.catpal_level': 'Current level',
    'profile.count': '{count} of {max} catpals',
    'profile.empty_team': 'Add the catpals you already have and the level of each.',
